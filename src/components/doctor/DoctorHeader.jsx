  ...
  useEffect(() => {
    ...
    const fetchDoctorDetails = async () => {
      try {
        ...
        console.error("Fetch doctor details failed:", error);
      ...
      <header className="w-full bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center">
            <NavLink to="/doctor" className="flex items-center gap-3 text-[#20c0f3] hover:text-[#1ba0d1] transition-colors">
            ...
            <div className="relative">
              ...
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM10.586 7.414L14 4l5 5-3.586 3.586M7 17l4.586-4.586M2 2l20 20" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636L12 12m6.364-6.364a9 9 0 010 12.728m0-12.728L5.636 18.364a9 9 0 1012.728 0L5.636 5.636a9 9 0 0112.728 0z" />
                </svg>
                {unreadCount > 0 && (
                ...
                >
                  ...
                  {notifications.length > 0 && (
                    <div className="p-4 border-t border-gray-200">
                      <button 
                        onClick={() => showToast("Đang phát triển tính năng này", "info")}
                        className="w-full text-center text-[#20c0f3] hover:text-[#1ba0d1] font-medium text-sm"
                      >
            ...
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 bg-gradient-to-r from-[#20c0f3] to-[#1ba0d1] rounded-full flex items-center justify-center text-white font-semibold">
                  {user?.user?.fullname ? user.user.fullname.charAt(0).toUpperCase() : 
                   user?.name ? user.name.charAt(0).toUpperCase() : 'D'}
                </div>
                <div className="hidden md:block text-left">
                  <p className="font-medium text-sm">
                    {user?.user?.fullname || user?.name || "Doctor"}
                  </p>
                  <p className="text-xs text-gray-500">
                    {user?.user?.email || user?.email || "doctor@bookingcare.com"}
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="py-2">
                    ...
                    >
                      ...
                      <span className="text-gray-700">Lịch khám bệnh</span>
                    </button>
