    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="relative h-96 flex items-center justify-center bg-gradient-to-r from-[#223a66] to-[#2c4a7a] overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-light mb-4 leading-tight mt-2">
            Đặt <span className="font-bold text-[#23cf7c]">Lịch Hẹn</span>
          </h1>
          <p className="text-lg md:text-xl font-light opacity-90">
            Lên lịch tư vấn cùng đội ngũ bác sĩ chuyên khoa của chúng tôi
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-light text-[#223a66] mb-4 mt-2">
                Lịch <span className="font-bold">Khám Bệnh</span>
              </h2>
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Vui lòng điền thông tin bên dưới để đặt lịch khám cùng bác sĩ
              </p>
            </div>
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {doctors.map((doc) => (
                        <option key={doc.id} value={doc.id}>
                          Bác sĩ {doc.user?.fullname || "(Chưa có tên)"}
                        </option>
                      ))}
                    </select>
                  </div>
                    ...
                    >
                      ...
                      {schedules
                        ...
                        .map((schedule) => {
                          ...
                          return (
                            <option key={schedule.id} value={schedule.id}>
                              {startTimeString} - {endTimeString} ({schedule.booking_limit - schedule.number_booked} chỗ trống)
                            </option>
                          );
                        })}
                    </select>
                ...
                <div>
                  ...
                  <textarea
                    className="w-full p-4 rounded-xl border-2 border-gray-200 focus:border-[#23cf7c] focus:outline-none transition duration-300 resize-none text-gray-700"
                    rows="5"
                    placeholder="Vui lòng mô tả triệu chứng hoặc lý do khám (ví dụ: đau đầu, sốt, khám tổng quát...)"
                    value={reason}
                    onChange={(e) => setReason(e.target.value)}
                    required
                    maxLength={500}
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <p className="text-sm text-gray-500">
                      Vui lòng cung cấp thông tin chi tiết để bác sĩ chuẩn bị tốt hơn cho buổi khám
                    </p>
                    <span className="text-xs text-gray-400">
                ...
                {amount > 0 && (
                  <div className="bg-[#23cf7c]/10 rounded-xl p-6 border border-[#23cf7c]/20">
                    <div className="flex items-center justify-between">
                      <span className="text-[#223a66] font-semibold text-lg">Phí khám:</span>
                      <span className="text-[#23cf7c] font-bold text-2xl">
                        {amount.toLocaleString('vi-VN')} VND
                      </span>
                    </div>
