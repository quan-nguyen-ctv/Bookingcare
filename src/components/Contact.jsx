...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.status === "success") {
        setStatusMsg("Cảm ơn bạn đã liên hệ! Chúng tôi sẽ phản hồi trong vòng 24 giờ.");
        setStatusType("success");
        setFormData({
          name: "",
          email: "",
        ...
        setStatusMsg("Có lỗi xảy ra. Vui lòng thử lại sau.");
        setStatusType("error");
      }
    } catch (err) {
      console.error("Error sending message:", err);
      setStatusMsg("Lỗi mạng. Vui lòng kiểm tra kết nối và thử lại.");
      setStatusType("error");
    }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#23cf7c] transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#23cf7c] transition-all resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-[#23cf7c] to-[#20c997] text-white font-semibold py-4 px-8 rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
                    {loading ? (
                      <>
                        <FaSpinner className="animate-spin" />
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6 bg-gray-50">
                  <div className="flex items-center gap-3 mb-2">
                    <FaMapMarkerAlt className="text-[#23cf7c]" />
                    <span className="font-semibold text-[#223a66]">Spa Center</span>
                  </div>
                  <p className="text-gray-600 text-sm">
                    123 Đường Sức khỏe, Quận Y tế<br />
                    Thành phố Health, HC 12345
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-r from-[#223a66] to-[#2c4a7a] py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-[#23cf7c] hover:bg-[#20c997] text-white font-semibold py-4 px-8 rounded-full transition-all hover:shadow-lg">
                Đặt lịch hẹn
              </button>
              <button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#223a66] font-semibold py-4 px-8 rounded-full transition-all">
                Gọi ngay
              </button>
            </div>
          </div>
