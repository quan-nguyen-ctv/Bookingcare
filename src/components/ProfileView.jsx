  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        setError("Tải thông tin hồ sơ thất bại");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#223a66] text-lg">Đang tải hồ sơ của bạn...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-500 mb-2">Không thể tải hồ sơ</h3>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 mb-8 pb-8 border-b border-gray-200">
              ...
              <div className="text-center md:text-left">
                <h2 className="text-3xl font-bold text-[#223a66] mb-2">{user.fullname || "Người dùng"}</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-gray-700 font-medium">{user.fullname || "Chưa cập nhật"}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-gray-700 font-medium">{user.gender || "Chưa cập nhật"}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-gray-700 font-medium break-all">{user.email || "Chưa cập nhật"}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <p className="text-gray-700 font-medium">{user.phone_number || "Chưa cập nhật"}</p>
                  </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold text-[#223a66] mb-6">Hành động nhanh</h3>
