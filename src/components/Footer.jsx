      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <img src="/src/components/img/LOGO SPA-01.png" alt="Logo" className="mb-4 w-40" />
            <p>
              Chúng tôi luôn cam kết mang đến dịch vụ chất lượng cao, an toàn và chuyên nghiệp để mang lại trải nghiệm tốt nhất cho khách hàng.
            </p>
            <div className="flex mt-4 space-x-4">
              <a href="https://www.facebook.com/themefisher" className="text-gray-300 hover:text-gray-100">
                <FaFacebookF />
          ...
          {/* Department */}
          <div>
            <h4 className="text-xl font-semibold mb-3">Dịch vụ</h4>
            <div className="border-b-2 w-10 border-gray-300 mb-4"></div>
            <ul className="space-y-2">
              <li><a href="#!" className="hover:text-gray-100">Phẫu thuật</a></li>
              <li><a href="#!" className="hover:text-gray-100">Sức khỏe phụ nữ</a></li>
              <li><a href="#!" className="hover:text-gray-100">Chẩn đoán hình ảnh</a></li>
              <li><a href="#!" className="hover:text-gray-100">Tim mạch</a></li>
              <li><a href="#!" className="hover:text-gray-100">Nội khoa</a></li>
            </ul>
          </div>

          {/* Support */}
          <div>
            <h4 className="text-xl font-semibold mb-3">Hỗ trợ</h4>
            <div className="border-b-2 w-10 border-gray-300 mb-4"></div>
            <ul className="space-y-2">
              ...
              <li><a href="#!" className="hover:text-gray-100">Câu hỏi thường gặp</a></li>
              <li><a href="#!" className="hover:text-gray-100">Giấy phép hoạt động</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="text-xl font-semibold mb-3">Liên hệ</h4>
            <div className="border-b-2 w-10 border-gray-300 mb-4"></div>
        ...
        <div className="mt-10 border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <form className="mt-4 md:mt-0 flex space-x-2">
            <input
              ...
              required
            />
            <button className="bg-gray-300 text-[#252525] px-4 py-2 rounded-full hover:bg-gray-100">Đăng ký</button>
          </form>
        </div>
