    ...
    if (
      ...
      async function payOrderSuccess(bookingId, vnp_TransactionNo, vnp_ResponseCode) {
        try {
          ...
          const data = await res.json();
          if (res.ok && data.status === "success") {
            ToastSuccess("Thanh toán đặt lịch thành công.");
            navigate(`/booking/success?bookingId=${bookingId}`);
          } else {
            ToastError(data.message || "Thanh toán thất bại.");
          }
        } catch (error) {
          ToastError(error.message || "Thanh toán thất bại.");
        }
      }
    } else if (idBooking && vnp_TransactionNo && vnp_ResponseCode === "24") {
      setStatusPay("Pay_failed");
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-80 flex items-center justify-center bg-gradient-to-r from-[#223a66] to-[#2c4a7a] overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-light mb-4 leading-tight mt-2">
            {statusPay === "Pay_failed" ? (
              <>Thanh toán <span className="font-bold text-red-400">Thất bại</span></>
            ) : idBookingSuccess ? (
              <>Đặt lịch <span className="font-bold text-[#23cf7c]">Thành công</span></>
            ) : (
              <>Không có <span className="font-bold text-gray-300">Thông tin</span></>
            )}
          </h1>
          <p className="text-lg md:text-xl font-light opacity-90">
            {statusPay === "Pay_failed" 
          ...
          <div className="max-w-4xl mx-auto">
            {statusPay === "Pay_failed" ? (
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-8 text-center">
                  <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-8">
                    <h3 className="font-semibold text-red-800 mb-2">Nguyên nhân</h3>
                    <p className="text-red-700">
                      Thanh toán của bạn không thành công. Có thể do số dư không đủ, 
                      sự cố mạng hoặc hạn chế từ phương thức thanh toán.
                    </p>
                  </div>

                  <div className="space-y-4 mb-8">
                    <h4 className="text-lg font-semibold text-[#223a66]">Các bước tiếp theo:</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-50 rounded-xl p-4">
                        <h5 className="font-medium text-[#223a66] mb-2">Kiểm tra phương thức thanh toán</h5>
                        <p className="text-sm text-gray-600">Xác minh lại thông tin thẻ và số dư tài khoản</p>
                      </div>
                      <div className="bg-gray-50 rounded-xl p-4">
                        <h5 className="font-medium text-[#223a66] mb-2">Thử lại</h5>
                        <p className="text-sm text-gray-600">Quay lại đặt lịch và thử thanh toán lại</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="bg-[#23cf7c] p-8 text-white text-center">
                  ...
                  <p className="text-green-100">Cuộc hẹn của bạn đã được ghi nhận</p>
                </div>
                ...
                <div className="p-8">
                  <div className="text-center mb-8">
                    <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
                      ...
                      <p className="text-green-700">
                        Cuộc hẹn đã được chuyển tới cơ sở y tế. 
                        Vui lòng không đặt lịch qua kênh khác để tránh trùng lịch.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <div className="bg-gray-50 rounded-xl p-6 text-center">
                        ...
                        <h4 className="font-semibold text-[#223a66] mb-2">Đã xác nhận</h4>
                        <p className="text-sm text-gray-600">Lịch hẹn đã được lưu thành công</p>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-xl p-6 text-center">
                        ...
                        <h4 className="font-semibold text-[#223a66] mb-2">Đã lên lịch</h4>
                        <p className="text-sm text-gray-600">Cuộc hẹn đã được thêm vào lịch của bạn</p>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-xl p-6 text-center">
                        ...
                        <h4 className="font-semibold text-[#223a66] mb-2">Mã tham chiếu</h4>
                        <p className="text-sm text-gray-600">Mã đặt lịch của bạn để đối chiếu</p>
                      </div>
                    </div>
                  </div>

                  <div className="text-center">
                    <h4 className="text-lg font-semibold text-[#223a66] mb-4">Tiếp theo là gì?</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                      <div className="bg-blue-50 rounded-xl p-4">
                        <h5 className="font-medium text-[#223a66] mb-2">Chuẩn bị thăm khám</h5>
                        <p className="text-sm text-gray-600">Mang theo CMND/CCCD và hồ sơ y tế (nếu có)</p>
                      </div>
                      <div className="bg-blue-50 rounded-xl p-4">
                        <h5 className="font-medium text-[#223a66] mb-2">Đến sớm</h5>
                        <p className="text-sm text-gray-600">Vui lòng có mặt trước 15 phút so với giờ hẹn</p>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="bg-gray-500 p-8 text-white text-center">
                  ...
                  <h2 className="text-3xl font-bold mb-2">Không tìm thấy thông tin</h2>
                  <p className="text-gray-200">Không thể xác định chi tiết đặt lịch</p>
                </div>

                {/* Content */}
                <div className="p-8 text-center">
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
                    <h3 className="font-semibold text-gray-800 mb-2">Bạn có thể làm gì?</h3>
                    <p className="text-gray-700">
                      Thông tin đặt lịch bạn tìm có thể đã bị di chuyển hoặc không tồn tại. 
                      Vui lòng kiểm tra lịch sử đặt lịch hoặc tạo lịch hẹn mới.
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div className="bg-gray-50 rounded-xl p-4">
                      <h5 className="font-medium text-[#223a66] mb-2">Xem lịch sử</h5>
                      <p className="text-sm text-gray-600">Xem lại các cuộc hẹn trước đây của bạn</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4">
                      <h5 className="font-medium text-[#223a66] mb-2">Đặt lịch mới</h5>
                      <p className="text-sm text-gray-600">Tạo lịch hẹn mới với bác sĩ</p>
                    </div>
                  </div>
